...
@section('pageDescription')
    We develop web and cloud applications that suits business processes and requirement of our client. We are Raines Technologies Nigeria Limited committed to providing technological solutions to Nigeria and beyond
@endsection
    ...
    <div class="container" id="mobile-app">
        <div class="row">
            ...
            <div class="col-md-9">
                ...
                <div class="row mt-4">
                    <div class="col-md-7">
                        <p>We develop Web applications that can be as simple as applications that facilitate customer contact or as complex as those
                            that facilitate data collection, medical record keeping, banking, and such.</p>

                    </div>
                    <!-- Slideshow banner -->
                    <div class="col-md-5">
                        <p class="lead">Web applications leverage the convenience offered by Internet technologies to meet customer demand.</p>
                    </div>
                    <p class="col-12">These applications process data and store results in a back-end database
                    ...
                    <p class="col-12">
                        ...
                        user-friendly interfaces to users utilizing available technologies.
                    </p>
                </div>

                <div class="title-divider mt-4">
                    <h3>
                        <span>Technologies <span class="font-weight-normal text-muted">We Use</span></span>
                        <small>Our Web/Cloud apps are based on the following cutting edge technologies:</small>
                    </h3>
                </div>
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <ul class="fa-ul list-lg">
                            <li>
                                ...
                                <img class="img-fluid" src="/assets/img/services/html5.jpg" alt="html5">
                            </li>
                            <li>
                                <i class="fa-li fa fa-check text-primary"></i>
                                <h4>
                                ...
                                <img class="img-fluid" src="/assets/img/services/php.jpg" alt="php">
                            </li>
                            <li>
                                <i class="fa-li fa fa-check text-primary"></i>
                                <h4>
                                ...
                                <img class="img-fluid" src="/assets/img/services/js.jpg" alt="javascript">
                            </li>
                        </ul>
                    </div>
                    <div class="col-md-6">
                        ...
                        <ul class="fa-ul list-lg">
                            <li>
                                ...
                                <img class="img-fluid" src="/assets/img/services/css3.png" alt="css3">
                            </li>
                            <li>
                                <i class="fa-li fa fa-check text-primary"></i>
                                <h4>
                                ...
                                <img class="img-fluid" src="/assets/img/services/laravel.png" alt="laravel">
                            </li>
                            <li>
                                <i class="fa-li fa fa-check text-primary"></i>
                                <h4>
                                ...
                                <img class="img-fluid" src="/assets/img/services/wp.png" alt="wordpress">
                            </li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="row text-center text-lg-left">
                    <div class="col-12 col-lg-8 py-2">
                        <h2 class="text-uppercase font-weight-bold mt-0 mb-2">
                            <span class="text-shadow">Web / Cloud</span> <span class="text-primary-darkend">Application</span>
                        </h2>
                        <h5 class="text-faded">
                            Responsive <span class="text-primary-darkend font-weight-bold px-lg-1">/</span> Free Security Patches <span class="text-primary-darkend font-weight-bold px-lg-1">/</span> 99.99% Up time <span class="text-primary-darkend font-weight-bold px-lg-1">/</span> Cutting Edge Technologies
                        </h5>
                    </div>
